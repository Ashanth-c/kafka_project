...
public class JobController {
  ...
  private final Job letterCloudJob;
  ...
  public void letterJob() {
    runJobB(this.letterJob, "");
  }

  @RequestMapping("/letterCloudJob")
  public void setLetterCloudJob() {
    runJobB(this.letterCloudJob, "");
  }
